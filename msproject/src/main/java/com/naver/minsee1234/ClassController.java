...
public class ClassController {
	...
	public String classSearchListGo(Model model, HttpSession session) {
		Tb_classDao dao = sqlSession.getMapper(Tb_classDao.class);
		tb_grade.setStudent_no((String) session.getAttribute("sessionStudent_no"));
		...
		String student_no = (String) session.getAttribute("sessionStudent_no");
	...
	public String classRegistrationCancelAjax(@RequestParam String class_no, @RequestParam int credit,
		...
		String student_no = (String) session.getAttribute("sessionStudent_no");
		tb_grade.setClass_no(class_no);
		if (session.getAttribute("sessionStudent_no") == null) {
			return "login";
		}
		tb_grade.setStudent_no(student_no);
		tb_grade.setTerm_no(makeTermno());
